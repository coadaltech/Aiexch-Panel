                                ...
                                <CardContent className="space-y-4 sm:space-y-6 p-4 sm:p-6 pt-0">
                                    <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                                        {predefinedThemes.map((theme) => (
                                            <div
                                                key={theme.id}
                                                className={`relative border rounded-lg p-4 cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-105 ${settings.selectedTheme === theme.id
                ...
                <div className="xl:col-span-1 order-1 xl:order-2">
                    <Card className="xl:sticky xl:top-6">
                        ...
                        <CardContent className="p-4 sm:p-6 pt-0">
                            <div
                                className={`border rounded-lg overflow-hidden mx-auto transition-all duration-300 ${previewMode === "mobile"
