...
const navigation = [
  { id: "dashboard", name: "Dashboard", icon: LayoutDashboard, url: "/admin/dashboard" },
  { id: "users", name: "User Management", icon: Users, url: "/admin/users" },
  { id: "games", name: "Game Management", icon: Gamepad2, url: "/admin/games" },
  { id: "tournaments", name: "Tournaments", icon: Trophy, url: "/admin/tournaments" },
  { id: "promotions", name: "Promotions", icon: Upload, url: "/admin/promotions" },
  { id: "analytics", name: "Analytics", icon: BarChart3, url: "/admin/analytics" },
  { id: "white-label", name: "White Label", icon: Palette, url: "/admin/white-label" },
  { id: "settings", name: "Settings", icon: Settings, url: "/admin/settings" },
]
...
export function AdminSidebar({ sidebarOpen, setSidebarOpen }: AdminSidebarProps) {
  ...
  const handleNavigation = (item: typeof navigation[0]) => {
    router.push(item.url) // <-- yaha URL change hoga
    setSidebarOpen(false)
  }
